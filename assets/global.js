...
class FeaturesProducts extends HTMLElement {
  constructor() {
    super();
    const forms = this.querySelectorAll('.featured-products__form');
  ...
  onFormSubmit(event) {
    ...
    var variantId = this.querySelector('.product-variant-select').value;
    var quantity = 1;
...
customElements.define('featured-products', FeaturesProducts);